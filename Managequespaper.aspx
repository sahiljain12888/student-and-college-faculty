<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Managequespaper.aspx.cs" Inherits="Managequespaper" %>
...
<script type="text/javascript">
    ...
    function checkReqFieldsQuestionpaper(me) {

        //var returnValue;
        var title = document.getElementById("<%=txttitle.ClientID%>").value;
        var desc = document.getElementById("<%=txtdesc.ClientID%>").value;
        var video = document.getElementById("<%=uploadQuestionpaper.ClientID%>").value;
    ...
    <asp:ScriptManagerProxy ID="ScriptManagerProxy1" runat="server"></asp:ScriptManagerProxy>
     <div class="container mt-5">
        ...
        <div class="col-md-12 text-center">
            <h2 class="text-dark">Manage Questionpaper</h2>
        </div>

	    <div class="col-md-12 text-right mt-4">
		    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal"> Add Questionpaper </button>
	    </div>
		      ...
		      <div class="modal-dialog">
			    <div class="modal-content">
			      ...
			      <div class="modal-header">
				    <h4 class="modal-title text-center">Add Questionpaper</h4>
			      ...
			      <div class="modal-body">
				    <div class="col-md-12 mt-2">
                        <div class="col-md-12">
                            <label>Questionpaper Title :</label>
                        ...
                        <div class="col-md-12">
                            <label>Questionpaper Upload :</label>
                            <asp:FileUpload ID="uploadQuestionpaper" runat="server" CssClass="form-control"  />
                            <br />
                        </div>
                 ...
                 <asp:Button ID="btnadd" OnClick="btnadd_Click"  OnClientClick="return checkReqFieldsQuestionpaper(this)" class="btn btn-success" runat="server" Text="Submit" />
