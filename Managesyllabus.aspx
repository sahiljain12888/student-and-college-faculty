<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Managesyllabus.aspx.cs" Inherits="Managesyllabus" %>
...
<script type="text/javascript">
    ...
    function checkReqFieldsSyllabus(me) {

        //var returnValue;
        var title = document.getElementById("<%=txttitle.ClientID%>").value;
        var desc = document.getElementById("<%=txtdesc.ClientID%>").value;
        var video = document.getElementById("<%=uploadSyllabus.ClientID%>").value;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container mt-5">
        ...
        <div class="col-md-12 text-center">
            <h2 class="text-dark">Manage Syllabus</h2>
        </div>

	    <div class="col-md-12 text-right mt-4">
		    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal"> Add Syllabus </button>
	    </div>
		      ...
		      <div class="modal-dialog">
			    <div class="modal-content">
			      ...
			      <div class="modal-header">
				    <h4 class="modal-title text-center">Add Syllabus</h4>
			      ...
			      <div class="modal-body">
				    <div class="col-md-12 mt-2">
                        ...
                        <div class="col-md-12">
                            ...
                            <asp:FileUpload ID="uploadSyllabus" runat="server" CssClass="form-control"  />
                            <br />
                        </div>
			      ...
			      <div class="modal-footer">
                      <asp:Button ID="btnadd" OnClick="btnadd_Click" OnClientClick="return checkReqFieldsSyllabus(this)" class="btn btn-success" runat="server" Text="Submit" />
