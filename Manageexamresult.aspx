<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Manageexamresult.aspx.cs" Inherits="Manageexamresult" %>
...
<script type="text/javascript">
    ...
    function checkReqFields(me) {
        ...
        var Timetable = document.getElementById("<%=uploadresult.ClientID%>").value;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container mt-5">
        ...
        <div class="col-md-12 text-center">
            <h2 class="text-dark">Manage Results</h2>
        </div>

	    <div class="col-md-12 text-right mt-4">
		    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal"> Add Results </button>
	    </div>
		      ...
		      <div class="modal-dialog">
			    <div class="modal-content">
			      ...
			      <div class="modal-header">
				    <h4 class="modal-title text-center">Add Results</h4>
			      ...
			      <div class="modal-body">
				    <div class="col-md-12 mt-2">
                        ...
                        <div class="col-md-12">
                            <label>Results Upload :</label>
                            <asp:FileUpload ID="uploadresult" runat="server" CssClass="form-control"  />
                            <br />
                            <br />
                        </div>
                    </div>                                
